> **[Claude first idea · 2026-05-02]** ToDo 全清单 + 二八优先级。诊断详情见 [tracking-@PKM](tracking-@PKM.md) ##2026-05-02。
>
> **ToDo（按优先级）**
>
> | 优先级 | ToDo | 触发 / 何时做 |
> |---|---|---|
> | **P0** | 跑一篇 ref 入库走完整流程，记下卡顿点不顺手解决 | 现在（唯一动作，80% 价值） |
> | **P1** | A1 · tracking-@ 方法论（五层中唯一无结构的层） | P0 跑完立即 |
> | **P1** | A2 · 行动→提炼闭环（tracking → card / checklist） | 与 A1 绑定一起做 |
> | **P2** | card metadata 设计 + 全笔记 metadata 补全 | 流程稳定后 |
> | **P2** | 标题模板扩到 toolkit / book | 流程稳定后 |
> | **P2** | inbox 零散笔记分流（按本文顶部 4 类操作） | 流程稳定后 |
...
>   覆盖：刻意练习 + 资源整合 + 沟通 + 健康。素材见本文 §习惯养成。
>
> **B. 中候选 moc（DeepSeek 已提示）**
>
> - `moc-@决策杠杆` — 驱动问题："80/20 / 长尾 / 战略性懒惰 / 复利 / 机会成本——是同一概念簇的不同切片吗？"
>   覆盖：资源整合 + 抽象模型 + 刻意练习。原话见本文 §《二八法则》末尾 DeepSeek 建议。
>   注意：与 `moc-@理性思考模型总结` §1 约束条件有交集，建 moc 时需划清边界。
>
> **C. 不建议建 moc（重复 / 不必要）**
>
> - 多巴胺主题：4 本待读书 + 现有戒断多巴胺/成瘾——`moc-@认知链路` 已覆盖。
> - 如何高效阅读：只在 cluster 11 内部、不跨 cluster——按"先有跨 cluster 问题再造 moc"原则，先保留为 Overview 待挖入口。
>
> **D. 不是 moc，是整理任务**
>
> - 本文 8 段"book 残留"（思考快与慢 / 内向者沟通 / 刻意练习 / 精力管理 / 毫无意义的工作 / 二八法则 / 博弈论 / 血酬定律 / 像高手 / 谈谈方法）应回填到对应 book 笔记。
> - §Misc 的 7-8 个开放问题（系统 1↔2、设计思维 vs 灰度、攻壳机动队 vs 形而上学等）应转化为 `atom-` / `hypo-`。
> - §⭕《置身事内》《大国大城》的 8 本延伸阅读，是 cluster 10 待读书单，保留在 inbox 直到决定读。
>
> ### 建议处理顺序
>
...
> 3. inbox 残留回填——单独开一轮做
> 4. Misc → atom-——作为 inbox 收尾

---

✅ 表示该主题目前没有问题
⭕ 表示该主题目前有残留笔记，但尚未构成问题

[toc]

## 多巴胺书籍推荐：

你现在的书单锚点非常好，但有一个明显特征：
...
1️⃣ **《欲望分子多巴胺》（The Molecule of More）**
...
- 为什么多巴胺与预测、探索、未来有关
- 为什么它天然连接“认知更新”与“行动驱动”

缺点是略偏大众科普，但对你这个阶段来说，**刚刚好**。

------

2️⃣ **《多巴胺国度》（Dopamine Nation）**

Anna Lembke

这本书的价值不在神经细节，而在**系统性视角**：

- 高频刺激如何劫持精度
- 快速反馈如何让系统 2 失效
- 为什么“意志力”在某些环境中必然失败

你前面关于“精度通胀”的很多直觉，在这本书里能找到临床级别的佐证。

------

3️⃣ **《How Emotions Are Made》（情绪如何形成）**

Lisa Feldman Barrett

这本书非常重要，因为它会帮你**避免一个常见误解**：
...
| 书籍                  | 关联点                     | 差异点                   |
| :-------------------- | :------------------------- | :----------------------- |
| [ x ]《思考，快与慢》 | 补充认知偏差的心理学原理   | 更侧重理论而非操作工具   |
...
| [ x ]**《深度工作》** | 杠杆时间应用 | 侧重个体专注力管理                 |
| [ x ]**《长尾理论》** | 资源分配模式 | 论证非关键多数的价值（与本书互补） |
