...
[^1]: 见 [book-@刻意练习](book-@刻意练习.md) 与 [Ni-Te-audit](Ni-Te-audit.md) §方法论（原出处 `moc-@认知链路` §3d，2026-08-29 归档）
...
[^2]: 见 [PWPE与非对称决策模型](PWPE与非对称决策模型.md) §感知层 与 [card-@精度操控三型](card-@精度操控三型.md)（原出处 `moc-@认知链路` §3a，2026-08-29 归档）
...
- [PWPE与非对称决策模型](PWPE与非对称决策模型.md)：贝叶斯作为感知层的核心节点，串联自由能、精度、多巴胺
