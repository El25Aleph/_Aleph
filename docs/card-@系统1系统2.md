...
[^2]: 见 [Ni-Te-audit](!distill-Ni-Te-audit.md) §方法论：刻意练习 + 战略性懒惰（原出处 `moc-@认知链路` §3d，2026-08-29 归档）
...
- [PWPE与非对称决策模型](!distill-PWPE与非对称决策模型.md)：双系统作为感知层的分岔口——多巴胺活跃才调动系统 2 的主动推理与被动推理
