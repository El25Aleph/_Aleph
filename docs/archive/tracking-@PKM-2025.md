...
在 [blog-我的知识管理-再谈笔记构建](../tracking-@PKM.md)中提到，今后要使用 obsidian 作为知识管理工具。在 obsidian 中可以给 markdown 文件添加 YAML 属性，其本质是给文档添加一系列的元数据，方便后面使用 dataview 插件进行知识图谱的制作和文档关联的可视化。由此，引出问题：
...
从[blog-君主论](../book-@君主论.md)中提取了「AI 雇佣军」的概念，要警惕 AI 的双重面孔：
...
今天发布了一篇[博客](../tracking-@PKM-纸质记录.md)，列举了纸质笔记的应用场景和使用方法。其中提到：
