> **归档说明（2026-08-29）**
>
> 本篇（v1）2026-08-29 移入 `docs/archive/`——只移不删，仍可引用。
>
> 六个概念的去向：自由能 / 贝叶斯 / 精度 / 多巴胺 / 双系统 → [PWPE与非对称决策模型](../!distill-PWPE与非对称决策模型.md)，刻意练习 → [Ni-Te-audit](../!distill-Ni-Te-audit.md)，两处都比这里更细。唯一没被接住的「奥卡姆剃刀是自由能最小化的结果」（§3e + §4c）已择出成 [card-@奥卡姆剃刀](../card-@奥卡姆剃刀.md)。
>
> 归档前，三张 keystone card（[贝叶斯更新](../card-@贝叶斯更新.md) / [系统1系统2](../card-@系统1系统2.md) / [刻意练习](../card-@刻意练习.md)）指向本篇 §3 / §4c 的脚注已逐条改指上述新出处；[moc-@INTJ人生指南](../moc-@INTJ人生指南.md) §4 那句「这条链 v1 §4c 已经写完了」也已改写。
