...
>
> 六个概念的去向：自由能 / 贝叶斯 / 精度 / 多巴胺 / 双系统 → [PWPE与非对称决策模型](../PWPE与非对称决策模型.md)，刻意练习 → [Ni-Te-audit](../Ni-Te-audit.md)，两处都比这里更细。唯一没被接住的「奥卡姆剃刀是自由能最小化的结果」（§3e + §4c）已择出成 [card-@奥卡姆剃刀](../card-@奥卡姆剃刀.md)。
>
