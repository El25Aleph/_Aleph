...
> **归档说明（2026-08-29）**
>
> 本篇 2026-08-29 移入 `docs/archive/`——只移不删，仍可引用。
>
> 归档理由（2026-08-02 audit 判定）：5 个概念 [PWPE与非对称决策模型](../!distill-PWPE与非对称决策模型.md) 全有、且切得更细——PWPE 分成「非对称模型（引擎）」和「底层逻辑（操作系统）」两层，本篇只笼统归成一个「杠杆家族」，中心论点被更好的切法盖过。§1.3「区别与边界」表已于 2026-08-02 抢救进 PWPE 的 log（它比 PWPE 的边际收益清单多了「典型问题 / 风险」这个「何时用哪个」的角度）。
>
> §5 验证标准自己写着「如果完全没用到 → 说明 moc 设计偏理论，需要调整或归档」——这次归档正是按这条自证。
