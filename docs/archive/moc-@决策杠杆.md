...
>
> 归档理由（2026-08-02 audit 判定）：5 个概念 [PWPE与非对称决策模型](../PWPE与非对称决策模型.md) 全有、且切得更细——PWPE 分成「非对称模型（引擎）」和「底层逻辑（操作系统）」两层，本篇只笼统归成一个「杠杆家族」，中心论点被更好的切法盖过。§1.3「区别与边界」表已于 2026-08-02 抢救进 PWPE 的 log（它比 PWPE 的边际收益清单多了「典型问题 / 风险」这个「何时用哪个」的角度）。
>
